...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_General Information'))

WebUI.click(findTestObject('Object Repository/Page_General Information/i_keyboard_arrow_down'))

WebUI.click(findTestObject('Object Repository/Page_General Information/a_Logout'))
